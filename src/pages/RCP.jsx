...
const RCP = () => {
  ...
  return (
    // 1. Contenedor principal sin padding, ocupa toda la pantalla.
    <div className="min-h-screen bg-gray-100">
      <BackButton />

      {/* 2. Contenedor del contenido: centrado, con ancho máximo y padding horizontal. */}
      <div className="w-full max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        
        <div className="content-header py-2 sm:py-4 bg-white rounded-lg shadow-xl">
